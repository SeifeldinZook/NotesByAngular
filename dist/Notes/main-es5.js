(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Users/zook/GitHub/NotesByAngular/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    /***/
    function sew(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "URLguardGuard", function () {
        return URLguardGuard;
      });
      /* harmony import */
      ...
      var URLguardGuard = /*#__PURE__*/function () {
        function URLguardGuard(_AuthenticationService, _Router) {
          _classCallCheck(this, URLguardGuard);

          this._AuthenticationService = _AuthenticationService;
          this._Router = _Router;
        }

        _createClass(URLguardGuard, [{
          key: "canActivate",
      ...
      URLguardGuard.ɵfac = function URLguardGuard_Factory(t) {
        return new (t || URLguardGuard)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
      };

      URLguardGuard.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({
        token: URLguardGuard,
        factory: URLguardGuard.ɵfac,
        providedIn: "root"
      });
      /*@__PURE__*/

      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](URLguardGuard, [{
    ...
    function DZ0t(module, __webpack_exports__, __webpack_require__) {
      ...
      function ProfileComponent_div_3_div_4_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_div_3_div_4_Template_a_click_7_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

            var note_r4 = ctx.$implicit;

            var ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

            ctx_r5.getID(note_r4._id);
            return ctx_r5.setValue();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_div_3_div_4_Template_a_click_11_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);
            ...
            return ctx_r7.getID(note_r4._id);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProfileComponent_div_3_div_4_Template_div_click_15_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);
            ...
            ctx_r8.getID(note_r4._id);
            return ctx_r8.setValue();
          });
      ...
      function ProfileComponent_section_26_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function ProfileComponent_section_26_Template_form_ngSubmit_2_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10);

            var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

            return ctx_r9.editNote();
          });
      ...
      var ProfileComponent = /*#__PURE__*/function () {
        function ProfileComponent(_Router, _NotesService) {
          var _this = this;
          ...
          var dataExctractedJWT = {
            token: this.token,
            userID: this.decoded._id
          };

          this._NotesService.getAllNotes(dataExctractedJWT).subscribe(function (data) {
            _this.isRenedered = true;
            _this.allNotes = data.Notes;
          });
        ...
        _createClass(ProfileComponent, [{
          ...
          value: function addNewNote() {
            ...
            this._NotesService.addNoteToDB(data).subscribe(function (data) {
              if (data.message == 'success') {
                var dataExctractedJWT = {
                  token: _this2.token,
                  userID: _this2.decoded._id
                };

                _this2._NotesService.getAllNotes(dataExctractedJWT).subscribe(function (data) {
                  _this2.isRenedered = true;
                  _this2.allNotes = data.Notes;
                });

                _this2.addNoteFormGroup.reset();
              }
            });
          }
        }, {
          ...
          value: function deleteNote() {
            ...
            this._NotesService.deleteNoteFromDB(data).subscribe(function (data) {
              if (data.message == 'deleted') {
                var dataExctractedJWT = {
                  token: _this3.token,
                  userID: _this3.decoded._id
                };

                _this3._NotesService.getAllNotes(dataExctractedJWT).subscribe(function (data) {
                  _this3.isRenedered = true;
                  _this3.allNotes = data.Notes;
                });
              }
            });
          }
          ...
          value: function setValue() {
            for (var index = 0; index < this.allNotes.length; index++) {
          ...
          value: function editNote() {
            ...
            this._NotesService.updateNoteInDB(editData).subscribe(function (res) {
              if (res.message == 'updated') {
                var dataExctractedJWT = {
                  token: _this4.token,
                  userID: _this4.decoded._id
                };

                _this4._NotesService.getAllNotes(dataExctractedJWT).subscribe(function (data) {
                  _this4.isRenedered = true;
                  _this4.allNotes = data.Notes;
                });
              }
            });
          }
          ...
          key: "ngOnInit",
          value: function ngOnInit() {// $('#profile').particleground()   
          }
        }]);
      ...
      ProfileComponent.ɵfac = function ProfileComponent_Factory(t) {
        return new (t || ProfileComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_notes_service__WEBPACK_IMPORTED_MODULE_4__["NotesService"]));
      };
      ...
      ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ɵangular_packages_forms_forms_y"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControlStatusGroup"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroupDirective"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["DefaultValueAccessor"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControlName"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["MaxLengthValidator"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"]],
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        directives: [_components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_1__["NavbarComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"], _footer_footer_component__WEBPACK_IMPORTED_MODULE_3__["FooterComponent"]],
    ...
    function UR1(module, __webpack_exports__, __webpack_require__) {
      ...
      function SignInComponent_h6_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SignInComponent_h6_7_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h6", 11);
      ...
      function SignInComponent_span_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
      ...
      function SignInComponent_h6_11_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SignInComponent_h6_12_Template(rf, ctx) {
        if (rf & 1) {
        ...
        _createClass(SignInComponent, [{
          ...
          value: function signInSubmit() {
            ...
            if (this.signInFormGroup.valid) {
              this._AuthenticationService.signIn(this.signInFormGroup.value).subscribe(function (data) {
                console.log(data);

                if (data.message == 'success') {
                  _this5._Router.navigate(['/profile']);

                  _this5.isClicked = false;
                  _this5.isSuccess = true;
                  _this5.isUniuqeEmail = false;
                  _this5.ResponseMessage = data.message;

                  _this5.signInFormGroup.reset();

                  localStorage.setItem("NotesToken", data.token);
                } else {
                  console.log(data);
                  _this5.isUniuqeEmailMessage = data.message;
                  _this5.isUniuqeEmail = true;
                  _this5.isSuccess = false;
                  _this5.isClicked = false;
                }
              });
            }
      ...
      SignInComponent.ɵfac = function SignInComponent_Factory(t) {
        return new (t || SignInComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
      };
      ...
      SignInComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function SignInComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function SignInComponent_Template_form_ngSubmit_2_listener() {
              return ctx.signInFormGroup.valid && ctx.signInSubmit();
            });
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
        ...
        providers: [],
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpClientModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _components_navbar_navbar_component__WEBPACK_IMPORTED_MODULE_4__["NavbarComponent"], _components_not_found_not_found_component__WEBPACK_IMPORTED_MODULE_5__["NotFoundComponent"], _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_6__["ProfileComponent"], _components_sign_in_sign_in_component__WEBPACK_IMPORTED_MODULE_7__["SignInComponent"], _components_sign_up_sign_up_component__WEBPACK_IMPORTED_MODULE_8__["SignUpComponent"], _footer_footer_component__WEBPACK_IMPORTED_MODULE_11__["FooterComponent"]],
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_9__["ReactiveFormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_10__["HttpClientModule"]]
        });
      })();
      /*@__PURE__*/
    ...
    function ezX(module, __webpack_exports__, __webpack_require__) {
      ...
      var NotesService = /*#__PURE__*/function () {
        function NotesService(_HttpClient) {
      ...
      FooterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function FooterComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](16, " Copyright \xA9 2020 ");
    ...
    function hrlM(module, __webpack_exports__, __webpack_require__) {
      ...
      function NavbarComponent_li_10_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function NavbarComponent_li_10_Template_a_click_1_listener() {
      ...
      NavbarComponent.ɵfac = function NavbarComponent_Factory(t) {
        return new (t || NavbarComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_1__["AuthenticationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
      };
    ...
    function ujIQ(module, __webpack_exports__, __webpack_require__) {
      ...
      function SignUpComponent_h6_7_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SignUpComponent_h6_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h6", 17);
      ...
      function SignUpComponent_h6_12_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SignUpComponent_h6_14_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h6", 18);
      ...
      function SignUpComponent_h6_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h6", 18);
      ...
      function SignUpComponent_h6_20_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SignUpComponent_h6_21_Template(rf, ctx) {
        if (rf & 1) {
        ...
        _createClass(SignUpComponent, [{
          ...
          value: function signUpSubmit() {
            ...
            if (this.signUpFormGroup.valid) {
              this._AuthenticationService.signUp(this.signUpFormGroup.value).subscribe(function (data) {
                if (data.message == 'success') {
                  _this6._Router.navigate(['/signin']);

                  _this6.isClicked = false;
                  _this6.isSuccess = true;
                  _this6.isUniuqeEmail = false;
                  _this6.ResponseMessage = data.message;

                  _this6.signUpFormGroup.reset();

                  console.log(data);
                } else {
                  _this6.isUniuqeEmailMessage = data.errors.email.message;
                  _this6.isUniuqeEmail = true;
                  _this6.isSuccess = false;
                  _this6.isClicked = false;
                  console.log(data);
                }
              });
      ...
      SignUpComponent.ɵfac = function SignUpComponent_Factory(t) {
        return new (t || SignUpComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](src_app_services_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]));
      };
        ...
        template: function SignUpComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function SignUpComponent_Template_form_ngSubmit_2_listener() {
              return ctx.signUpFormGroup.valid && ctx.signUpSubmit();
            });
    ...
    function vY5A(module, __webpack_exports__, __webpack_require__) {
      ...
      var _Guards_urlguard_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./Guards/urlguard.guard */
      "2sew");
      ...
      var routes = [{
        ...
        path: "profile",
        canActivate: [_Guards_urlguard_guard__WEBPACK_IMPORTED_MODULE_6__["URLguardGuard"]],
